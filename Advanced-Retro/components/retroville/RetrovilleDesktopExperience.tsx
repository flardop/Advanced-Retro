...
const worldbuildingItems = [
  {
    ...
    reference: 'Plaza central, skyline cívico y arquitectura fundacional',
  ...
  },
  {
    ...
    reference: 'El vertedero emocional y mecánico de Retroville',
  ...
  {
    title: 'RETROVILLE NIGHTS',
    eyebrow: 'SECTOR 03',
    text: 'Cuando baja la luz, la ciudad cambia de tono. Clubs, terrazas y esquinas con neón convierten la noche en un sistema paralelo donde todo parece más elegante, más peligroso y bastante menos estable.',
    reference: 'Vida nocturna, ocio y fachada social de la ciudad',
  ...
  },
  {
    ...
    eyebrow: 'SECTOR 04',
    text: 'La ciudad se mueve como si cada trayecto fuera una mecánica. Metro-pods, taxis cápsula, motos absurdamente limpias y vehículos que parecen diseñados por alguien que creció dentro de un catálogo de hardware.',
    reference: 'Infraestructura de movilidad y transporte urbano',
    image: '/images/retroville/retroville-metro-pod-concept.png',
    placeholder: null,
    align: 'right' as const,
    accent: 'rgba(104, 193, 255, 0.20)',
  },
  {
    title: 'URBAN PROP SYSTEM',
    eyebrow: 'SECTOR 05',
    text: 'Farolas joystick, kioscos battery bar, marquesinas, señales, buzones, recreativas públicas y basura con identidad. Los objetos menores son los que terminan haciendo que Retroville parezca una ciudad habitable.',
    reference: 'Mobiliario urbano, señalética y utilería del mundo',
    image: '/images/retroville/retroville-urban-props-concept.png',
    placeholder: null,
    align: 'left' as const,
    accent: 'rgba(0,255,136,0.16)',
  },
  {
    title: 'CREATURE LAYER',
    eyebrow: 'SECTOR 06',
    text: 'La fauna de Retroville no es decorativa: discos que vuelan, perros-cartucho, gatos floppy y criaturas cableadas que convierten cada barrio en algo más vivo, raro y reconocible.',
    reference: 'Exploración de fauna y vida menor del universo',
    image: '/images/retroville/retroville-creatures-concept.png',
    placeholder: null,
    align: 'right' as const,
    accent: 'rgba(255, 122, 163, 0.18)',
  },
] as const;
