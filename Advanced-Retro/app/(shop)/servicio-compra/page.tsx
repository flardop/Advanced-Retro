...
export const metadata: Metadata = buildPageMetadata({
  title: 'Encargos retro 1:1 | Compra segura por encargo (5 €)',
  description:
    'Servicio de compra por encargo de AdvancedRetro.es: localizamos juegos y consolas, validamos estado y te acompañamos por ticket privado.',
  path: '/servicio-compra',
  keywords: [
    'servicio de encargo retro',
    'buscar juego retro',
    'compra segura coleccionismo',
    'encargo game boy',
  ],
});
...
export default function ConciergeServicePage() {
  const faqSchema = buildFaqJsonLd([
    {
      question: '¿Qué incluye el servicio de encargo de 5 €?',
      answer:
        'Incluye apertura de seguimiento, búsqueda de opciones de mercado, revisión y recomendación antes de compra.',
    },
    {
      question: '¿El encargo garantiza encontrar cualquier juego?',
      answer:
        'No siempre. El servicio cubre gestión y validación; la disponibilidad depende del mercado y del presupuesto.',
    },
    {
      question: '¿Cómo se hace el seguimiento del encargo?',
      answer:
        'El seguimiento se realiza por ticket privado comprador-tienda, con actualizaciones durante todo el proceso.',
    },
  ]);

  const breadcrumbSchema = buildBreadcrumbJsonLd([
    { name: 'Inicio', path: '/' },
    { name: 'Encargos', path: '/servicio-compra' },
  ]);
