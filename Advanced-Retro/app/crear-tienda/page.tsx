...
export const metadata = buildPageMetadata({
  ...
  description: 'Asistente avanzado para diseñar y lanzar tu propia tienda dentro del ecosistema AdvancedRetro.',
  path: '/crear-tienda',
  noIndex: true,
    ...
    return (
      <main className="min-h-screen bg-[linear-gradient(180deg,#09101b_0%,#10131b_100%)] px-5 py-12 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,14,24,0.9),rgba(8,12,20,0.96))] p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
          ...
          <p className="mt-5 text-base leading-8 text-slate-300">El creador de tiendas se conecta con tu perfil y tu membresía. Entra primero y te llevamos después al wizard completo.</p>
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(103,177,255,0.12),transparent_24%),linear-gradient(180deg,#09101b_0%,#10131b_100%)] px-5 py-12 text-white sm:px-8 lg:px-10">
      <div className="mx-auto max-w-7xl space-y-8">
        <section className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,14,24,0.9),rgba(8,12,20,0.96))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.22)] sm:p-8">
          ...
          <h1 className="mt-4 text-4xl font-black text-white sm:text-5xl">Tu tienda dentro del ecosistema</h1>
          <p className="mt-5 max-w-[54rem] text-base leading-8 text-slate-300">Vamos a diseñar una tienda con tu nombre, estilo, categoría y dirección creativa. El wizard genera la primera versión y luego podrás ajustarla desde tu dashboard.</p>
        </section>
