...
export const metadata = buildPageMetadata({
  ...
  description: 'Descubre las tiendas del ecosistema AdvancedRetro: escaparates propios, estética independiente y coleccionismo con personalidad.',
  path: '/tiendas',
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(103,177,255,0.12),transparent_24%),linear-gradient(180deg,#09101b_0%,#10131b_100%)] px-5 py-12 text-white sm:px-8 lg:px-10">
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <section className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,14,24,0.9),rgba(8,12,20,0.96))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.22)] sm:p-8">
          <p className="text-xs uppercase tracking-[0.28em] text-primary">Directory</p>
          <h1 className="mt-4 text-4xl font-black text-white sm:text-5xl">Tiendas de la comunidad</h1>
          <p className="mt-5 max-w-[54rem] text-base leading-8 text-slate-300">Este es el siguiente paso natural para AdvancedRetro: una capa de tiendas personales con identidad propia, pero integradas en el ecosistema principal.</p>
        </section>
            ...
            <article key={store.slug} className="overflow-hidden rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,14,24,0.9),rgba(8,12,20,0.96))] shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {store.official ? <span className="rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-primary">Tienda oficial</span> : null}
                </div>
