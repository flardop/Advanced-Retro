          ...
          <section className="mt-12 grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)]">
            ...
            <aside className="rounded-[1.8rem] border border-white/10 bg-white/[0.03] p-6">
              ...
              <div className="mt-6 flex flex-col gap-3">
                <Link href="/retroville" className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-full border border-[rgba(255,191,82,0.26)] bg-[linear-gradient(135deg,rgba(255,191,82,0.22),rgba(192,57,43,0.2))] px-5 text-[11px] font-bold uppercase tracking-[0.18em] text-white transition hover:border-[rgba(255,191,82,0.5)] hover:bg-[linear-gradient(135deg,rgba(255,191,82,0.3),rgba(192,57,43,0.28))]">
                  Volver a la landing
