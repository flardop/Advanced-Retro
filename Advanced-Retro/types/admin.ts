...
export type RetrovilleAnalyticsSnapshot = {
  summary: {
    ...
    eventSignupsInRange: number;
    eventConversionRate: number;
    buyerCtaClicksInRange: number;
    calendarSavesInRange: number;
    privateDocumentInteractionsInRange: number;
    trafficShare: number;
  ...
  deviceBreakdown: ChartPoint[];
  browserBreakdown: ChartPoint[];
  osBreakdown: ChartPoint[];
  topCountries: ChartPoint[];
  topCities: ChartPoint[];
  entryPages: ChartPoint[];
  exitPages: ChartPoint[];
  eventBreakdown: ChartPoint[];
