...
export default function RetrovilleEventSignupCard({
  ...
  return (
    <div className="mt-5 overflow-hidden rounded-[1.4rem] border border-[var(--rv-green)]/18 bg-[linear-gradient(145deg,rgba(0,255,136,0.08),rgba(8,11,20,0.92)_42%,rgba(138,215,255,0.1))] p-5 sm:p-6">
      <div className="flex flex-wrap items-center gap-2">
        <span className="inline-flex min-h-[28px] items-center rounded-full border border-[var(--rv-green)]/25 bg-[rgba(0,255,136,0.08)] px-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-[var(--rv-green)]">
          Primer reveal
        </span>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.02fr)_minmax(300px,0.98fr)]">
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex min-h-[42px] items-center justify-center gap-2 rounded-full border border-[var(--rv-cyan)]/24 bg-[rgba(138,215,255,0.08)] px-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--rv-accent)] transition hover:border-[var(--rv-cyan)]/40 hover:bg-[rgba(138,215,255,0.14)] hover:text-white"
            >
        ...
        <div className="rounded-[1.25rem] border border-white/10 bg-[rgba(7,11,22,0.72)] p-4 sm:p-5">
          <p className="text-[10px] uppercase tracking-[0.24em] text-[var(--rv-gold)]">Registro rápido</p>
