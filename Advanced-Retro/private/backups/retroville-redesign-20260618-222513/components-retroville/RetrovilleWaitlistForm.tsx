  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {success ? (
        <p
          aria-live="polite"
          className={`rounded-2xl border px-4 py-3 text-sm ${darkMode ? 'border-emerald-400/25 bg-emerald-400/10 text-emerald-200' : 'border-emerald-200 bg-emerald-50 text-emerald-700'}`}
        >
          {success}
        </p>
      ) : null}
