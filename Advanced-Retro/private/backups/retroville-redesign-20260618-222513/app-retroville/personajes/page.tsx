...
const colorGuideSlides = [
  ...
  {
    title: 'Retroville Cast',
    type: 'Anatomía base',
    image: '/images/retroville/characters/character-anatomy-sheet.webp',
    alt: 'Hoja de anatomía base del reparto de Retroville con proporciones y construcción visual',
  },
  {
    title: 'Button Crew Sheet',
    type: 'Hoja visual',
    image: '/images/retroville/characters/button-crew-sheet.webp',
    alt: 'Hoja visual del Button Crew con poses, proporciones y detalles de desarrollo',
  },
  {
    title: 'Nora',
    type: 'Character sheet',
    image: '/images/retroville/retroville-nora-sheet.png',
    alt: 'Character sheet de Nora con diseño, poses y detalles del personaje de Retroville',
  },
  {
    title: 'Joy & Grump',
    type: 'Character sheet',
    image: '/images/retroville/retroville-joy-grump-sheet.png',
    alt: 'Character sheet de Joy y Grump con diseño de pareja y expresiones del dúo',
  },
  {
    title: 'Yaya',
    type: 'Character sheet',
    image: '/images/retroville/retroville-yaya-sheet.png',
    alt: 'Character sheet de Yaya con desarrollo visual y acabado del personaje',
  },
  {
    title: 'City Hall Worker',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/city-hall-worker-sheet.png',
    alt: 'Sheet de desarrollo del personaje City Hall Worker dentro del universo Retroville',
  },
  {
    title: 'Crux',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/crux-sheet.png',
    alt: 'Sheet de desarrollo de Crux con exploración visual del personaje',
  },
  {
    title: 'Joy & Grump Expressions',
    type: 'Expresiones',
    image: '/images/retroville/dev-characters/joy-grump-expression-sheet.png',
    alt: 'Sheet de expresiones faciales de Joy y Grump para desarrollo de acting y tono',
  },
  {
    title: 'Joy & Grump Dev',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/joy-grump-sheet.png',
    alt: 'Sheet de desarrollo de Joy y Grump con construcción visual del dúo',
  },
  {
    title: 'Mayor Tube',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/mayor-tube-sheet.png',
    alt: 'Sheet de desarrollo de Mayor Tube con diseño y presencia del alcalde de Retroville',
  },
  {
    title: 'Mayor Tube v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/mayor-tube-v2-sheet.png',
    alt: 'Segunda revisión visual de Mayor Tube con variantes del diseño del personaje',
  },
  {
    title: 'Nano',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/nano-sheet.png',
    alt: 'Sheet de desarrollo de Nano con diseño, proporciones y variantes del personaje',
  },
  {
    title: 'Nona Girl',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/nona-girl-sheet.png',
    alt: 'Sheet de desarrollo de Nona Girl con silueta y acabado del personaje',
  },
  {
    title: 'Nora Senior',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/nora-senior-sheet.png',
    alt: 'Sheet de desarrollo de Nora Senior con iteraciones y presencia del personaje',
  },
  {
    title: 'Nora v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/nora-v2-sheet.png',
    alt: 'Segunda revisión visual de Nora con una nueva iteración del diseño del personaje',
  },
  {
    title: 'Patrol Chief',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/patrol-chief-sheet.png',
    alt: 'Sheet de desarrollo del Patrol Chief con presencia policial y variantes del personaje',
  },
  {
    title: 'Patrol Chief v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/patrol-chief-v2-sheet.png',
    alt: 'Segunda revisión visual del Patrol Chief con ajustes de diseño y silueta',
  },
  {
    title: 'Patrol Crew v2',
    type: 'Grupo en desarrollo',
    image: '/images/retroville/dev-characters/patrol-crew-v2-sheet.png',
    alt: 'Sheet grupal de Patrol Crew con exploración visual de la unidad de patrulla',
  },
  {
    title: 'Pipo',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/pipo-sheet.png',
    alt: 'Sheet de desarrollo de Pipo con poses y variantes del personaje',
  },
  {
    title: 'Pipo v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/pipo-v2-sheet.png',
    alt: 'Segunda revisión visual de Pipo con ajustes de forma y actitud',
  },
  {
    title: 'Public Crew',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/public-crew-sheet.png',
    alt: 'Sheet de desarrollo de Public Crew con exploración de uniforme y presencia de grupo',
  },
  {
    title: 'Public Crew v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/public-crew-v2-sheet.png',
    alt: 'Segunda revisión visual de Public Crew con variantes del grupo de transporte',
  },
  {
    title: 'Shift Stick',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/shift-stick-sheet.png',
    alt: 'Sheet de desarrollo de Shift Stick con construcción visual del operador de tránsito',
  },
  {
    title: 'Tomo',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/tomo-sheet.png',
    alt: 'Sheet de desarrollo de Tomo con poses, actitud y variantes del personaje',
  },
  {
    title: 'Tomo v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/tomo-v2-sheet.png',
    alt: 'Segunda revisión visual de Tomo con ajustes de silueta y expresión',
  },
  {
    title: 'Trimp',
    type: 'Sheet de desarrollo',
    image: '/images/retroville/dev-characters/trimp-sheet.png',
    alt: 'Sheet de desarrollo de Trimp con proporciones, poses y presencia competitiva',
  },
  {
    title: 'Trimp v2',
    type: 'Revisión visual',
    image: '/images/retroville/dev-characters/trimp-v2-sheet.png',
    alt: 'Segunda revisión visual de Trimp con nueva iteración del personaje',
  },
] as const;
        ...
        <div className={styles.visualGuidesRail}>
          {colorGuideSlides.map((guide) => (
            <article key={guide.title} className={styles.visualGuideCard} aria-label={guide.title}>
              ...
              <div className={styles.visualGuideMeta}>
                <p className={styles.visualGuideType}>{guide.type}</p>
                <h3 className={`${displayFont.className} ${styles.visualGuideTitle}`}>{guide.title}</h3>
              </div>
            </article>
          ))}
        </div>
